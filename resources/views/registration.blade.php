...
<head>
    ...
    <!-- BEGIN: Page CSS-->
    {{ header_style_sheets( Request::path() ) }}
    <!-- END: Page CSS-->
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="javascript:void(0);">
                            ...
                            <h2 class="brand-text text-primary ml-1">Fire Clearance</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid w-100" src="{{ asset('images/pages/login-v2-dark.svg') }}" alt="Register V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Register-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h4 class="card-title mb-1">Let's start here 🚀</h4>
                                <p class="card-text mb-2">Make your application for Fire Clearance easy and fun!</p>
                                <form class="auth-register-form mt-2" action="{{ route('registration.index') }}" method="POST">
                                    @csrf
