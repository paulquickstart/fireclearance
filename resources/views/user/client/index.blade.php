            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                <li class="nav-item dropdown dropdown-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                        ...
                        <a class="dropdown-item" href="javascript:void(0);"><i class="mr-50" data-feather="power"></i> Logout</a>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item active"><a class="d-flex align-items-center" href="#"><i data-feather="home"></i><span class="menu-title text-truncate" >Dashboard</span></a>
                </li>
                <hr/>
                ...
                <hr/>
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="power"></i><span class="menu-title text-truncate" >Logout</span></a>
                </li>
        ...
        <div class="content-wrapper">
            <div class="content-body">
                <div class="row match-height">
                    ...
                    <div class="col-md-12 col-xl-6">
                        <a class="card bg-primary text-white clearance">
                            <div class="px-2 pt-2 pb-0">
                                <div class="clearance-id">12345678</div>
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <div class="clearance-title">Tops Building</div>
                                        <div class="clearance-location">CLIP-SEZ, Basak, Lapu-lapu City</div>
                                    </div>
                                    <div>
                                        <div class="clearance-header">Payables</div>
                                        <div class="clearance-payable">Php 50,000</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="px-2 pt-0 pb-2 d-flex">
                                <div><span class="font-weight-bold">FSEC</span> <span class="badge badge-pill badge-success ml-25">Approved</span> </div>
                                <div class="ml-1"><span class="font-weight-bold">FSIC</span> <span class="badge badge-pill badge-secondary ml-25">Not Available</span> </div>
                            </div>
